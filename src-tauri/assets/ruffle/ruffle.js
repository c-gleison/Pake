(() => {
  ...
  var e = {
    ...
    124(e, n, a) {
      e.exports = a.p + "5f5ab961195569500f64.wasm";
    },
    797(e, n, a) {
      e.exports = a.p + "1a6dc3b1f908ca373e34.wasm";
    },
  };
  const n = {};
  function a(t) {
  ...
  ((a.m = e),
    (a.cw = (e) => {
      ...
      return () => {
        if (e) {
          var a = e;
          ((e = 0), (n = { exports: {} }), a.call(n.exports, n, n.exports));
        }
        return n.exports;
      };
    }),
    ...
    (a.u = (e) =>
      "core.ruffle." +
      { 482: "abdee977774955ff9b77", 655: "f53d3333c2db54409094" }[e] +
      ".js"),
    (a.g = (function () {
        ...
        if (void 0 !== o) {
          ...
          for (var u = 0; u < e.length; u++) {
            ...
            if (
              ...
              a.getAttribute("data-webpack") == n + o
            ) {
              s = a;
              break;
            }
    ...
    (() => {
      ...
      const e = { 792: 0 };
      a.f.j = (n, t) => {
        let r = a.o(e, n) ? e[n] : void 0;
        if (0 !== r)
          if (r) t.push(r[2]);
          else {
            const o = new Promise((a, t) => (r = e[n] = [a, t]));
            t.push((r[2] = o));
            const i = new Error(),
              s = (t) => {
                if (a.o(e, n) && ((r = e[n]), 0 !== r && (e[n] = void 0), r)) {
  ...
  var t = a.cw(function (e, n) {
    ...
    r = a.cw(function (e, n) {
      ...
      const a = l(),
        t = c();
      function r(e, n, ...r) {
        if ("function" == typeof e) return e({ ...n, children: r });
        const { finalTag: o, finalAttrs: i } = (0, t.applyTsxTag)(e, n),
          s = (0, t.createDomElement)(o, i);
        return (i && (0, a.setAttributes)(s, i), (0, t.applyChildren)(s, r), s);
      }
      n.h = r;
    ...
    s = a.cw(function (e, n) {
      ...
      function r(e, n) {
        ...
        const { children: r, ...o } = n,
          { finalTag: i, finalAttrs: s } = (0, t.applyTsxTag)(e, o),
          l = (0, t.createDomElement)(i, s);
        return ((0, a.setAttributes)(l, s), (0, t.applyChildren)(l, [r]), l);
      }
    }),
    l = a.cw(function (e, n) {
    ...
    c = a.cw(function (e, n) {
      ...
      ((n.applyChildren = function e(n, t) {
        ...
        (n.applyTsxTag = function (e, n) {
          ...
          t &&
            "tsxTag" in t &&
            ((a = t.tsxTag), !t.is && e.includes("-") && (t = { ...t, is: e }));
  ...
  class d {
    ...
    static fromSemver(e) {
      ...
      let o = 0,
        ...
        l = null;
      return (
        void 0 !== t[1] && (o = parseInt(t[1], 10)),
        void 0 !== t[2] && (i = parseInt(t[2], 10)),
        ...
        if ("||" === e) a.length > 0 && (t.push(a), (a = []));
          ...
          if (n) {
            const t = e.slice(0, n.index).trim(),
              r = d.fromSemver(e.slice(n.index).trim());
            a.push({ comparator: t, version: r });
          }
        }
      return (a.length > 0 && t.push(a), new f(t));
    }
  }
  class m {
    constructor(e) {
  ...
  const p = {
    versionNumber: "0.6.0-nightly.2026.9.3",
    versionName: "0.6.0-nightly.2026.9.3",
    versionChannel: "nightly",
    buildDate: "2026-09-03T00:38:25.034Z",
    commitHash: "3da8526a3bb5257e2fcbc49d20236191e8c957f7",
  };
  var h, v, g, b, w, k, y, j, R, z, x, S, F, C, A;
  (!(function (e) {
    ...
    (function (e) {
      ((e.None = "none"), (e.MainThread = "mainThread"));
    })(C || (C = {})),
    (function (e) {
      ((e.South = "south"),
        (e.East = "east"),
  ...
  const E = {
    ...
    letterbox: g.Fullscreen,
    unmuteOverlay: b.Visible,
    upgradeToHttps: !0,
    ...
    openUrlMode: z.Allow,
    allowNetworking: x.All,
    openInNewTab: null,
    socketProxy: [],
    fontSources: [],
    defaultFonts: {},
    credentialAllowList: [],
    playerRuntime: R.FlashPlayer,
    gamepadButtonMapping: {},
    urlRewriteRules: [],
    scrollingBehavior: S.Smart,
    deviceFontRenderer: F.Embedded,
    backgroundExecutionMode: C.MainThread,
  };
  class P {
    constructor(e) {
      this.value = e;
  ...
  class W extends P {
    static supportsValue(e) {
      ...
      if (e instanceof P) return W.supportsValue(e.valueOf());
  ...
  function D(e, n, a) {
    if (a === n) return !0;
    if (a instanceof O && n instanceof O && a.value === n.value) return !0;
    if (n instanceof O && "string" == typeof a) {
  ...
  function M(e, n, a) {
    return n[a]
      ? L(e, n[a].value)
      : (e.reportError(new RangeError("No default")), new q());
  }
  function $(e, n) {
    const a = [],
      t = Object.create(null);
    for (const r of n)
      "narg" === r.type ? (t[r.name] = I(e, r.value)) : a.push(I(e, r));
  ...
  function I(e, n) {
    switch (n.type) {
      case "str":
        return n.value;
      case "num":
        return new O(n.value, { minimumFractionDigits: n.precision });
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof a) {
            ...
            case "number":
              return new O(a);
            case "object":
              if (W.supportsValue(a)) return new W(a);
            default:
              return (
                e.reportError(
                  new TypeError(
      ...
      case "func":
        return (function (e, { name: n, args: a }) {
          ...
          try {
            ...
            return (e.reportError(a), new q(`${n}()`));
          }
        })(e, n);
      case "select":
        return (function (e, { selector: n, variants: a, star: t }) {
          let r = I(e, n);
          if (r instanceof q) return M(e, a, t);
          for (const n of a) {
            if (D(e, r, I(e, n.key))) return L(e, n.value);
          }
          return M(e, a, t);
        })(e, n);
      default:
  ...
  function T(e, n) {
    if (e.dirty.has(n))
      return (e.reportError(new RangeError("Cyclic reference")), new q());
    e.dirty.add(n);
    const a = [],
  ...
  function B(e, n) {
    let a = e[0];
    if (a instanceof q) return new q(`NUMBER(${a.valueOf()})`);
    if (a instanceof O) return new O(a.valueOf(), { ...a.opts, ...U(n, _) });
    if (a instanceof W) return new O(a.toNumber(), { ...U(n, _) });
  ...
  function H(e, n) {
    let a = e[0];
    if (a instanceof q) return new q(`DATETIME(${a.valueOf()})`);
    if (a instanceof W || a instanceof O) return new W(a, U(n, V));
  ...
  class K {
    constructor(
      ...
      ((this._terms = new Map()),
        ...
        (this._functions = { NUMBER: B, DATETIME: H, ...n }),
        (this._useIsolating = a),
        (this._transform = t),
        (this._intls = (function (e) {
          const n = Array.isArray(e) ? e.join(" ") : e;
          let a = J.get(n);
          return (void 0 === a && ((a = new Map()), J.set(n, a)), a);
        })(e)));
    }
    hasMessage(e) {
    ...
    formatPattern(e, n = null, a = null) {
      ...
      let t = new N(this, a, n);
      try {
        return T(t, e).toString(t);
      } catch (e) {
        if (t.errors && e instanceof Error)
          return (t.errors.push(e), new q().toString(t));
        throw e;
      }
    }
  }
  ...
  class we {
    constructor(e) {
      ...
      function l() {
        let t;
        if ((a(ae) && (t = i(ae)), "{" === e[n] || "}" === e[n]))
          return u(t ? [t] : [], 1 / 0);
        let r = g();
        return r
          ? t
            ? u([t, r], r.length)
            : ((r.value = b(r.value, ie)), u([r], r.length))
          : t
            ? b(t, se)
            : null;
      }
      function u(t = [], r) {
        ...
        let o = t.length - 1,
          s = t[o];
        "string" == typeof s && (t[o] = b(s, se));
        let l = [];
        for (let e of t)
          (e instanceof ke && (e = e.value.slice(0, e.value.length - r)),
            e && l.push(e));
        return l;
      }
      function c() {
        ...
        if (r(he)) {
          ...
          return (r(de, SyntaxError), { type: "select", selector: e, ...n });
        }
      ...
      function d() {
        ...
        if (a(ee)) {
          ...
          if (r(pe)) {
            ...
            if (ne.test(t)) return { type: "func", name: t, args: o };
  ...
  class je {
    ...
    addLikelySubtags() {
      const e = (function (e) {
        if (Object.prototype.hasOwnProperty.call(Re, e)) return new je(Re[e]);
        const n = new je(e);
        if (n.language && ze.includes(n.language))
  ...
  function xe(e, n, { strategy: a = "filtering", defaultLocale: t } = {}) {
    const r = (function (e, n, a) {
      const t = new Set(),
        r = new Map();
      for (let e of n) new je(e).isWellFormed && r.set(e, new je(e));
      e: for (const n of e) {
  ...
  function Ae() {
    (("function" == typeof Array.prototype.reduce &&
      ...
      ("function" == typeof Window && Ce(Window)) ||
        ("function" == typeof window.constructor &&
          Ce(window.constructor) &&
  ...
  const Ee = {
      ...
      "nb-NO": {
        ...
        "messages.ftl": "",
        "save-manager.ftl":
          "save-delete-prompt = Er du sikker p\xe5 at du vil slette filen?\nsave-download = Last ned\nsave-replace = Erstatt\nsave-delete = Slett\n",
        "volume-controls.ftl":
  ...
  for (const [e, n] of Object.entries(Ee)) {
    ...
    if (n) {
      ...
      for (const [r, o] of Object.entries(n))
        if (o) {
          t ??= Se();
          for (const n of a.addResource(new we(o)))
  ...
  function Oe(e, n) {
    const a = Se(),
      t = xe(navigator.languages, Object.keys(Pe), { defaultLocale: "en-US" });
    for (const a in t) {
      const r = qe(t[a], e, n);
      if (r) return r;
    }
    return (console.error(`Unknown text key '${e}'`), Fe(a), e);
  }
  function We(e, n) {
      ...
      (0, s().jsx)(function () {
        return (0, s().jsxs)("div", {
          ...
          children: [
            ...
            (0, s().jsx)("div", {
              class: "loadbar",
              children: (0, s().jsx)("div", { class: "loadbar-inner" }),
            }),
          ],
        });
      }, {}),
      ...
      (0, s().jsx)(function () {
        return (0, s().jsx)("div", {
          ...
          children: (0, s().jsxs)("div", {
            ...
            class: "modal-area",
            children: [
              (0, s().jsx)("span", { class: "close-modal" }),
              (0, s().jsx)("div", {
                class: "general-save-options",
                children: (0, s().jsx)("span", { class: "modal-button" }),
              }),
              (0, s().jsx)("table", { id: "local-saves" }),
            ],
          }),
        });
      }, {}),
            ...
            children: (0, s().jsxs)("div", {
              ...
              children: [
                ...
                (0, s().jsx)("label", {
                  id: "volume-mute",
                  for: "mute-checkbox",
                  title: Oe("volume-controls-unmute"),
                }),
                (0, s().jsx)("label", {
                  id: "volume-min",
                  for: "mute-checkbox",
                  title: Oe("volume-controls-mute"),
                }),
                (0, s().jsx)("label", {
                  id: "volume-mid",
                  for: "mute-checkbox",
                ...
                (0, s().jsx)("span", { id: "volume-slider-text" }),
                (0, s().jsx)("span", { class: "close-modal" }),
              ],
            }),
          }),
      ...
      (0, s().jsx)(function () {
        return (0, s().jsx)("div", {
          ...
          children: (0, s().jsxs)("div", {
            ...
            children: [
              (0, s().jsx)("span", { class: "close-modal" }),
              (0, s().jsx)("h2", { children: Oe("clipboard-message-title") }),
              (0, s().jsx)("p", { id: "clipboard-modal-description" }),
              (0, s().jsxs)("p", {
                children: [
                  (0, s().jsxs)("b", { children: [De, "+C"] }),
                  (0, s().jsx)("span", {
                    children: Oe("clipboard-message-copy"),
                  }),
                ],
              }),
              (0, s().jsxs)("p", {
                children: [
                  (0, s().jsxs)("b", { children: [De, "+X"] }),
                  (0, s().jsx)("span", {
                    children: Oe("clipboard-message-cut"),
                  }),
                ],
              }),
              (0, s().jsxs)("p", {
                children: [
                  (0, s().jsxs)("b", { children: [De, "+V"] }),
                  (0, s().jsx)("span", {
                    children: Oe("clipboard-message-paste"),
                  }),
                ],
              }),
            ],
    ...
    Me.content.appendChild(
      (0, s().jsx)(function () {
        return (0, s().jsx)("div", {
          ...
          class: "hidden",
          children: (0, s().jsx)("ul", { id: "context-menu" }),
        });
      }, {}),
    ));
  const $e = "application/x-shockwave-flash",
  ...
  try {
    if (
      ...
      (e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        (Ue = new URL(".", e)),
        (_e = Ue.protocol.includes("extension")));
    }
  } catch (e) {
    console.warn("Unable to get currentScript URL", e);
  }
  const Be = "https://ruffle.rs";
  ...
  class Ke extends Error {
    constructor(e) {
      super(`Failed to begin SWF load: ${e}`);
    }
  }
  ...
  const Ge = {
    OpenDemo: {
      type: "open_link",
      url: Be + "/demo",
      label: Oe("ruffle-demo"),
    },
    DownloadDesktop: {
      type: "open_link",
      url: Be + "/downloads#desktop-app",
      label: Oe("ruffle-desktop"),
    },
    UpdateRuffle: {
      type: "open_link",
      url: Be + "/downloads",
      label: Oe("update-ruffle"),
    },
    CreateReport: { type: "create_report" },
    ShowDetails: { type: "show_details" },
    createReportOrUpdate() {
      return Qe() ? this.UpdateRuffle : this.CreateReport;
    },
    openWiki: (e, n) => ({
      type: "open_link",
      url: `https://github.com/ruffle-rs/ruffle/wiki/${e}`,
      label: n ?? Oe("ruffle-wiki"),
    }),
  };
  function Ye(e, n, a, t) {
    const r = a.join(""),
      { body: o, actions: l } = (function (e) {
        if (e instanceof Ve)
          return e.swfUrl && !e.swfUrl.protocol.includes("http")
            ? {
                body: We("error-file-protocol"),
                actions: [Ge.OpenDemo, Ge.DownloadDesktop],
              }
            : window.location.origin === e.swfUrl?.origin ||
                e.statusNotOk ||
                window.location.protocol.includes("extension")
              ? { body: We("error-swf-fetch"), actions: [Ge.ShowDetails] }
              : {
                  body: We("error-swf-cors"),
                  actions: [
                    Ge.openWiki("Using-Ruffle#configure-cors-header"),
                    Ge.ShowDetails,
                  ],
                };
        if (e instanceof He)
          return { body: We("error-invalid-swf"), actions: [Ge.ShowDetails] };
        if (e instanceof Je) {
          ...
          if (n.includes("mime"))
            return {
              body: We("error-wasm-mime-type"),
              actions: [
                Ge.openWiki("Using-Ruffle#configure-webassembly-mime-type"),
                Ge.ShowDetails,
              ],
            };
          if (
          ...
          if (n.includes("disallowed by embedder"))
            return {
              body: We("error-csp-conflict"),
              actions: [
                Ge.openWiki("Using-Ruffle#configure-wasm-csp"),
                Ge.ShowDetails,
              ],
            };
          if ("CompileError" === e.cause.name && n.includes("bad type"))
            return {
              body: We("error-wasm-unsupported-browser"),
              actions: [Ge.openWiki("#web"), Ge.ShowDetails],
            };
          if (
            "CompileError" === e.cause.name ||
            n.includes("failed to execute 'compile' on 'webassembly'")
          )
            return {
              body: We("error-wasm-invalid"),
              actions: [
          ...
          if (
            ...
            return {
              body: We("error-wasm-download"),
              actions: [Ge.ShowDetails],
            };
          if ("TypeError" === e.cause.name) {
            const e = We("error-javascript-conflict");
            return (
              Qe() &&
                e.appendChild(
              ...
              { body: e, actions: [Ge.createReportOrUpdate(), Ge.ShowDetails] }
            );
          }
          return navigator.userAgent.includes("Edg") &&
            n.includes("webassembly is not defined")
            ? {
                body: We("error-wasm-disabled-on-edge"),
                actions: [
                  Ge.openWiki(
            ...
            : {
                body: We("error-wasm-not-found"),
                actions: [
                  Ge.openWiki("Using-Ruffle#configuration-options"),
                  Ge.ShowDetails,
                ],
              };
        }
        if (e instanceof Ze)
          return {
            body: We("error-javascript-config"),
            actions: [
              Ge.openWiki("Using-Ruffle#javascript-api"),
              Ge.ShowDetails,
            ],
          };
        if (e instanceof Ke) {
          ...
          if (
            n.includes("is not a valid url") ||
            n.includes("invalid url") ||
            n.includes("invalid base url")
          ) {
            let e;
            try {
              (new URL(document.baseURI), (e = !0));
            } catch {
              e = !1;
            }
            return e
              ? { body: We("error-url-invalid"), actions: [Ge.ShowDetails] }
              : {
                  body: We("error-javascript-conflict"),
                  actions: [Ge.ShowDetails],
                };
          }
        }
        return {
          body: We("error-unknown", {
            buildDate: p.buildDate,
            outdated: String(Qe),
          }),
          actions: [Ge.createReportOrUpdate(), Ge.ShowDetails],
        };
      })(n),
      u = (0, i().createRef)(),
      c = (0, i().createRef)(),
      d = () => {
        u.current.classList.remove("hidden");
      };
    ((e.textContent = ""),
      e.appendChild(
        (0, s().jsxs)("div", {
          ...
          children: [
            (0, s().jsx)("div", {
              id: "panic-title",
              children: Oe("panic-title"),
            }),
            (0, s().jsx)("div", { id: "panic-body", children: o }),
            (0, s().jsx)("div", {
              id: "panic-footer",
              children: (0, s().jsx)("ul", {
                children: l.map((e) =>
                    ...
                    if ("show_details" === e.type) {
                      ...
                      return (0, s().jsx)("li", {
                        children: (0, s().jsx)("a", {
                          ...
                          onClick: e,
                          children: Oe("view-error-details"),
                        }),
                      });
                    }
                    if ("open_link" === e.type)
                  ...
                  (0, s().jsx)("span", {
                    ...
                    onClick: () => {
                      c.current &&
                        ...
                        c.current.classList.add("copied"),
                        setTimeout(() => {
                          c.current?.classList.remove("copied");
                        }, 2e3));
                    },
                  }),
                  (0, s().jsx)("span", {
                    class: "close-modal",
                    onClick: () => u.current.classList.add("hidden"),
                  }),
                  (0, s().jsx)("textarea", { readOnly: !0, children: r }),
                ],
              }),
            }),
          ],
  ...
  async function on(e) {
    null === rn &&
      (rn = (async function (e) {
        Ae();
        const n = (await Promise.all([Xe(), tn(), nn(), an(), en()])).every(
          Boolean,
        );
        (n ||
          console.log(
        ...
        const {
          ...
          : a.e(482).then(() => a(482)));
        let i;
        const s = n ? new URL(a(797), a.b) : new URL(a(124), a.b),
          l = await fetch(s),
        ...
        return (await t({ module_or_path: i }), [r, o]);
      })(e));
    const n = await rn;
  ...
  function sn(e, n) {
    if (e === n) return 0;
    const a = e.compareDocumentPosition(n);
  ...
  function ln(e) {
    const n = Object.getOwnPropertyDescriptor(Document.prototype, "embeds");
    if (!n?.get) return;
    const a = Symbol("ruffle_embeds_cache");
      ...
      get() {
        ...
        const o = () => {
            const a = n.get.call(this),
              t = (function (e) {
                const n = ["ruffle-embed"];
                for (let a = 1; a <= e; a++) n.push(`ruffle-embed-${a}`);
                return n.join(", ");
              })(e),
              r = Array.from(this.querySelectorAll(t));
            return (function (e, n, a) {
              ...
              for (; r < e.length && o < n.length; ) {
                const i = e[r],
                  s = n[o];
                a(i, s) <= 0 ? (t.push(i), r++) : (t.push(s), o++);
              }
              for (; r < e.length; ) t.push(e[r++]);
              for (; o < n.length; ) t.push(n[o++]);
              return t;
            })(Array.from(a), r, sn);
          },
          i = () => (
          ...
          s = Object.create(HTMLCollection.prototype);
        (Object.defineProperty(s, "length", {
          ...
          (s.namedItem = function (e) {
            const n = i();
            for (const a of n) {
              const n = a;
              if (e && (n.getAttribute("name") === e || n.id === e)) return n;
            }
            return null;
          }),
        ...
        const l = new Proxy(s, {
          get(e, n, a) {
            if ("string" == typeof n) {
              const t = Number(n);
              if (!Number.isNaN(t) && t >= 0) return i()[t];
              if (Reflect.has(e, n)) return Reflect.get(e, n, a);
              const r = e.namedItem(n);
              if (r) return r;
            }
          ...
          has(e, n) {
            if ("string" == typeof n) {
              ...
              return !Number.isNaN(a) && a >= 0
                ? a < i().length
                : !!Reflect.has(e, n) || null !== e.namedItem(n);
            }
          ...
          ownKeys() {
            const e = i().length,
              n = [];
            for (let a = 0; a < e; a++) n.push(String(a));
            return n;
          },
          getOwnPropertyDescriptor(e, n) {
            if ("string" == typeof n) {
              const e = Number(n);
              if (!Number.isNaN(e) && e >= 0 && e < i().length)
                return {
                  enumerable: !0,
                  configurable: !0,
                  writable: !1,
      ...
      for (; t < 999; ) {
        ...
        if (
          ...
          return (
            ...
            "ruffle-embed" === e && ln(t),
            (un[e] = { class: n, name: a, internalName: e }),
            a
          );
        t += 1;
      }
  ...
  function fn(e, n) {
    if (
      (dn(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      dn(n.backgroundColor) &&
      ...
      dn(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      dn(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      dn(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      dn(n.base) && e.setBaseUrl(n.base),
      dn(n.menu) && e.setShowMenu(n.menu),
      dn(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      dn(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      dn(n.forceAlign) && e.setForceAlign(n.forceAlign),
      dn(n.quality)
        ...
        : void 0 !== window.orientation &&
          ...
          e.setQuality("low")),
      dn(n.scale) && e.setScale(n.scale.toLowerCase()),
      dn(n.forceScale) && e.setForceScale(n.forceScale),
      dn(n.frameRate) && e.setFrameRate(n.frameRate),
      dn(n.wmode) && e.setWmode(n.wmode),
      dn(n.logLevel) && e.setLogLevel(n.logLevel),
      dn(n.maxExecutionDuration) &&
      ...
      dn(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      dn(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      dn(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      dn(n.allowNetworking) &&
        e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      dn(n.credentialAllowList) &&
        e.setCredentialAllowList(n.credentialAllowList),
      dn(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      dn(n.socketProxy))
    )
      for (const a of n.socketProxy)
        e.addSocketProxy(a.host, a.port, a.proxyUrl);
    if (dn(n.gamepadButtonMapping))
      for (const [a, t] of Object.entries(n.gamepadButtonMapping))
        e.addGamepadButtonMapping(a, t);
    if (dn(n.urlRewriteRules))
    ...
    (dn(n.scrollingBehavior) && e.setScrollingBehavior(n.scrollingBehavior),
      dn(n.deviceFontRenderer) &&
  ...
  class gn {
    constructor(e, n, a) {
      ((this.contextMenuForceDisabled = !1),
        ...
        (this.SaveRow = ({ rowKey: e, solName: n, solData: a }) =>
          (0, s().jsxs)("tr", {
            children: [
              (0, s().jsx)("td", { title: e, children: n }),
              (0, s().jsx)("td", {
                children: (0, s().jsx)("span", {
                  class: "save-option",
                  id: "download-save",
                  title: Oe("save-download"),
                  onClick: () =>
                    Rn(
                      (function (e, n) {
                        const a = zn(e);
        ...
        this.shadow.appendChild(Me.content.cloneNode(!0)),
        ...
        (this.volumeSettings = new bn(!1, 100)),
      ...
      t &&
        ...
        (t.innerText = Oe("save-backup-all")));
      const r = this.unmuteOverlay.querySelector("#unmute-overlay-svg");
      if (r) {
        r.querySelector("#unmute-text").textContent = Oe("click-to-unmute");
      }
      ...
      (this.contextMenuElement.addEventListener("contextmenu", o),
        ...
        (this._readyState = h.HaveNothing),
        (this.metadata = null),
    ...
    setupTabVisibilityHandling() {
      document.addEventListener("visibilitychange", () => {
        ...
        const e = this.loadedConfig?.backgroundExecutionMode ?? C.None;
        document.hidden
          ? ((this.lastActivePlayingState = this.instance.is_playing()),
            e === C.MainThread
              ? (this.instance.enable_background_tick_mode(),
                this.lastActivePlayingState && this.startBackgroundTick())
              : this.instance.pause())
          : (e === C.MainThread &&
              (this.stopBackgroundTick(),
              this.instance.restart_animation_loop()),
            this.lastActivePlayingState && this.instance.play(),
    ...
    startBackgroundTick() {
      ...
      try {
        const n = new Blob([e], { type: "application/javascript" }),
          a = URL.createObjectURL(n),
          t = new Worker(a);
        (URL.revokeObjectURL(a),
          (this.backgroundWorker = t),
          (t.onmessage = () => {
            this.backgroundWorker === t &&
    ...
    stopBackgroundTick() {
      (this.backgroundWorker?.terminate(), (this.backgroundWorker = null));
    }
    updateStyles() {
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await on(this.onRuffleDownloadProgress.bind(this)).catch(
        (e) => {
      ...
      if (
        ...
        !this.loadedConfig ||
          this.loadedConfig.autoplay === v.On ||
          (this.loadedConfig.autoplay !== v.Off &&
            "running" === this.audioState()))
      ) {
        if ((this.play(), "running" !== this.audioState())) {
          ((this.loadedConfig &&
            this.loadedConfig.unmuteOverlay === b.Hidden) ||
    ...
    async reloadWithCanvasRenderer() {
      if (
        this.loadedConfig &&
        this.loadedConfig.preferredRenderer !== y.Canvas
      ) {
        const e = { ...this.loadedConfig, preferredRenderer: y.Canvas };
        await this.load(e);
      } else {
        if (!this.loadedConfig)
          throw new Error("Cannot reload if load wasn't first called");
        this.panic(new Error(Oe("error-canvas-reload")));
      }
    }
    async load(e, n = !1) {
      if (
        ...
        if (!jn(this.element))
          try {
            ((this.loadedConfig = {
              ...E,
              ...(n && "url" in e
                ? { allowScriptAccess: Fn("samedomain", e.url) }
                : {}),
              ...
              this.loadedConfig.backgroundColor &&
                this.loadedConfig.wmode !== k.Transparent &&
              ...
              "url" in e
                ? (console.log(`Loading SWF file ${e.url}`),
                  ...
                  this.instance.stream_from(this.swfUrl.href, hn(e.parameters)))
                : "data" in e &&
    ...
    confirmReloadSave(e, n, a) {
      if (xn(n) && localStorage[e]) {
        if (!a) {
          if (!confirm(Oe("save-delete-prompt"))) return;
        }
        ...
        if (t.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              Oe("save-reload-prompt", { action: a ? "replace" : "delete" }),
            ) &&
            this.loadedConfig &&
            (this.destroy(),
      ...
      ((e.textContent = ""),
        Object.keys(localStorage).forEach((n) => {
          ...
          a &&
            ...
            xn(t) &&
            e.appendChild(
              (0, s().jsx)(this.SaveRow, { rowKey: n, solName: a, solData: t }),
            );
        }));
    }
    async backupSaves() {
      ...
      Rn(new Blob([e.save()], { type: "application/zip" }), "saves.zip");
    }
    ...
    contextMenuItems() {
      const e = [],
        n = () => {
          e.length > 0 && null !== e[e.length - 1] && e.push(null);
        };
      if (this.instance && this.isPlaying) {
        (this.instance.prepare_context_menu().forEach((a, t) => {
          (a.separatorBefore && n(),
            e.push({
              text: a.caption,
              onClick: async () => this.instance?.run_context_menu_callback(t),
              enabled: a.enabled,
              checked: a.checked,
            }));
        }),
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? e.push({
                text: Oe("context-menu-exit-fullscreen"),
                onClick: async () => this.setFullscreen(!1),
              })
            : e.push({
                text: Oe("context-menu-enter-fullscreen"),
                onClick: async () => this.setFullscreen(!0),
              })),
        e.push({
          text: Oe("context-menu-volume-controls"),
          onClick: async () => {
        ...
        this.instance &&
          ...
          (n(),
          e.push({
            text: Oe("context-menu-download-swf"),
            onClick: this.downloadSwf.bind(this),
          })),
        navigator.clipboard &&
          window.isSecureContext &&
          e.push({
            text: Oe("context-menu-copy-debug-info"),
            onClick: () => navigator.clipboard.writeText(this.getPanicData()),
          }),
        this.checkSaves() &&
          e.push({
            text: Oe("context-menu-open-save-manager"),
            onClick: this.openSaveManager.bind(this),
          }),
        n(),
        e.push({
          text: Oe("context-menu-about-ruffle", {
            flavor: _e ? "extension" : "",
    ...
    pointerDown(e) {
      ((this.pointerDownPosition = new vn(e.pageX, e.pageY)),
        (this.pointerMoveMaxDistance = 0),
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new vn(e.pageX, e.pageY),
    ...
    showContextMenu(e) {
      ...
      if ("contextmenu" === e.type && e.shiftKey)
        return void this.hideContextMenu();
      ...
      if (
        ("contextmenu" === e.type
          ...
          : (document.documentElement.addEventListener(
            ...
            e.stopPropagation()),
        [!1, j.Off].includes(this.loadedConfig?.contextMenu ?? j.On) ||
          (this.isTouch &&
            this.loadedConfig?.contextMenu === j.RightClickOnly) ||
          this.contextMenuForceDisabled)
      )
        return;
      for (; this.contextMenuElement.firstChild; )
        this.contextMenuElement.removeChild(this.contextMenuElement.firstChild);
      const n = this.contextMenuItems(),
        a = n.some((e) => null !== e && void 0 !== e.checked);
      this.contextMenuElement.classList.toggle("has-checkmarks", a);
      for (const e of n)
        if (null === e)
          ...
          const { text: n, onClick: a, enabled: t, checked: r } = e,
            o = (0, s().jsx)("li", {
              class: { "menu-item": !0, disabled: !1 === t, checked: !0 === r },
              "data-text": n,
              children: n,
            });
          if ((this.contextMenuElement.appendChild(o), !1 !== t)) {
            const e = async (e) => {
              (e.preventDefault(),
                e.stopPropagation(),
                await a(e),
      ...
      const t = this.element.getBoundingClientRect(),
        ...
        c = o.clientHeight;
      let d = e.clientX;
      d + i > u && (d = e.clientX - i >= 0 ? e.clientX - i : u - i);
      let f = e.clientY;
      f + l > c && (f = e.clientY - l >= 0 ? e.clientY - l : c - l);
      const m = d - t.x,
        p = f - t.y,
        h = "rtl" === getComputedStyle(this.contextMenuElement).direction;
      ((this.contextMenuElement.style.top = `${p}px`),
        h
          ? ((this.contextMenuElement.style.right = t.width - m + "px"),
            (this.contextMenuElement.style.left = ""))
          : ((this.contextMenuElement.style.right = ""),
            (this.contextMenuElement.style.left = `${m}px`)));
    }
    hideContextMenu() {
    ...
    getPanicData() {
      ...
      if (
        ...
        (e += "\n# Ruffle Info\n"),
        (e += `Version: ${p.versionNumber}\n`),
        (e += `Name: ${p.versionName}\n`),
        (e += `Channel: ${p.versionChannel}\n`),
        (e += `Built: ${p.buildDate}\n`),
        (e += `Commit: ${p.commitHash}\n`),
        (e += `Is extension: ${_e}\n`),
        (e += "\n# Metadata\n"),
        this.metadata)
      )
    ...
    panic(e) {
      ...
      (a.push(this.getPanicData()),
        Ye(this.container, n, a, this.swfUrl),
        this.destroy());
    }
    addOpenInNewTabMessage(e, n) {
      const a = new URL(n);
      if (this.loadedConfig?.parameters) {
        const e = hn(this.loadedConfig?.parameters);
      ...
      const t = (0, s().jsxs)("div", {
        children: [
          We("message-cant-embed"),
          (0, s().jsx)("div", {
            children: (0, s().jsx)("a", {
              href: "#",
              onClick: () => e(a),
              children: Oe("open-in-new-tab"),
            }),
          }),
        ],
      });
    ...
    displayRootMovieDownloadFailedMessage(e, n) {
      ...
      if (a && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const a = n.includes("HTTP Status is not OK:"),
          t = e ? new He(this.swfUrl) : new Ve(this.swfUrl, a);
        this.panic(t);
      }
    }
    displayMessageOrElement(e, n) {
      const a =
          e instanceof HTMLDivElement ? e : (0, s().jsx)("p", { children: e }),
        t = n
          ? null
          : (0, s().jsx)("div", {
              children: (0, s().jsx)("button", {
                id: "continue-btn",
                children: Oe("continue"),
              }),
            }),
        r = (0, s().jsx)("div", {
          id: "message-overlay",
    ...
    displayRestoredFromBfcacheMessage() {
      ...
      const e = We("message-restored-from-bfcache");
      this.displayMessageOrElement(e);
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = Oe("clipboard-message-description", {
    ...
    setMetadata(e) {
      ((this.metadata = e),
        (this._readyState = h.Loaded),
        this.hideSplashScreen(),
        this.element.dispatchEvent(new CustomEvent(gn.LOADED_METADATA)),
        this.element.dispatchEvent(new CustomEvent(gn.LOADED_DATA)));
    }
  }
  ((gn.LOADED_METADATA = "loadedmetadata"), (gn.LOADED_DATA = "loadeddata"));
  class bn {
    constructor(e, n) {
  ...
  function wn(e, n) {
    ...
    const r = Fn(n("allowScriptAccess"), e);
  ...
  class Pn {
    constructor(e) {
      (Cn.set(this, void 0), An(this, Cn, e, "f"));
    }
    addFSCommandHandler(e) {
      En(this, Cn, "f").addFSCommandHandler(e);
    }
    get readyState() {
      return En(this, Cn, "f")._readyState;
    }
    get metadata() {
      return En(this, Cn, "f").metadata;
    }
    get loadedConfig() {
      return En(this, Cn, "f").loadedConfig ?? null;
    }
    async reload() {
      await En(this, Cn, "f").reload();
    }
    async load(e, n = !1) {
      await En(this, Cn, "f").load(e, n);
    }
    resume() {
      En(this, Cn, "f").play();
    }
    get isPlaying() {
      return En(this, Cn, "f").isPlaying;
    }
    get volume() {
      return En(this, Cn, "f").volume;
    }
    set volume(e) {
      En(this, Cn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return En(this, Cn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return En(this, Cn, "f").isFullscreen;
    }
    setFullscreen(e) {
      En(this, Cn, "f").setFullscreen(e);
    }
    requestFullscreen() {
      En(this, Cn, "f").enterFullscreen();
    }
    exitFullscreen() {
      En(this, Cn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await En(this, Cn, "f").downloadSwf();
    }
    displayMessage(e) {
      En(this, Cn, "f").displayMessage(e);
    }
    suspend() {
      En(this, Cn, "f").pause();
    }
    ...
    set traceObserver(e) {
      En(this, Cn, "f").traceObserver = e;
    }
    get config() {
      return En(this, Cn, "f").config;
    }
    set config(e) {
      En(this, Cn, "f").config = e;
    }
    callExternalInterface(e, ...n) {
      return En(this, Cn, "f").callExternalInterface(e, n);
    }
  }
  Cn = new WeakMap();
  var qn,
  ...
  class Mn extends HTMLElement {
    ...
    get readyState() {
      return Wn(this, qn, "f")._readyState;
    }
    get metadata() {
      return Wn(this, qn, "f").metadata;
    }
    constructor() {
      (super(),
        qn.set(this, void 0),
            ...
            (e) => {
              try {
                Object.defineProperty(this, e, {
                  value: (...n) =>
                    Wn(this, qn, "f").callExternalInterface(e, n),
                  configurable: !0,
                });
              } catch (n) {
                console.warn(
        ...
        Wn(this, qn, "f").addFSCommandHandler((e, n) => {
          Wn(this, On, "f")?.call(this, e, n);
        }));
    }
    ruffle(e) {
      if (1 === (e ?? 1)) return new Pn(Wn(this, qn, "f"));
      throw new Error(`Version ${e} not supported.`);
    }
    get loadedConfig() {
      return Wn(this, qn, "f").loadedConfig ?? null;
    }
    connectedCallback() {
      Wn(this, qn, "f").updateStyles();
    }
    static get observedAttributes() {
      return ["width", "height", "align"];
    }
    attributeChangedCallback(e, n, a) {
      Mn.observedAttributes.includes(e) && Wn(this, qn, "f").updateStyles();
    }
    disconnectedCallback() {
      Wn(this, qn, "f").destroy();
    }
    async reload() {
      await Wn(this, qn, "f").reload();
    }
    async load(e, n = !1) {
      await Wn(this, qn, "f").load(e, n);
    }
    play() {
      Wn(this, qn, "f").play();
    }
    get isPlaying() {
      return Wn(this, qn, "f").isPlaying;
    }
    get volume() {
      return Wn(this, qn, "f").volume;
    }
    set volume(e) {
      Wn(this, qn, "f").volume = e;
    }
    get fullscreenEnabled() {
      return Wn(this, qn, "f").fullscreenEnabled;
    }
    get isFullscreen() {
      return Wn(this, qn, "f").isFullscreen;
    }
    setFullscreen(e) {
      Wn(this, qn, "f").setFullscreen(e);
    }
    enterFullscreen() {
      Wn(this, qn, "f").enterFullscreen();
    }
    exitFullscreen() {
      Wn(this, qn, "f").exitFullscreen();
    }
    async downloadSwf() {
      await Wn(this, qn, "f").downloadSwf();
    }
    pause() {
      Wn(this, qn, "f").pause();
    }
    set traceObserver(e) {
      Wn(this, qn, "f").traceObserver = e;
    }
    debugPlayerInfo() {
      return "";
    }
    PercentLoaded() {
      return Wn(this, qn, "f")._readyState === h.Loaded ? 100 : 0;
    }
    get config() {
      return Wn(this, qn, "f").config;
    }
    set config(e) {
      Wn(this, qn, "f").config = e;
    }
    displayMessage(e) {
      Wn(this, qn, "f").displayMessage(e);
    }
  }
  function $n(e, n) {
    if (e) {
  ...
  class In extends Mn {
    ...
    static get observedAttributes() {
      return [...Mn.observedAttributes, "src"];
    }
    attributeChangedCallback(e, n, a) {
      if (
    ...
    static isInterdictable(e) {
      ...
      return !!n && !jn(e) && (kn(n) ? (yn(e, "src"), !1) : Ne(n, a));
    }
    static fromNativeEmbedElement(e) {
      const n = cn("ruffle-embed", In),
  ...
  class Ln extends Mn {
    ...
    connectedCallback() {
      (super.connectedCallback(), (this.params = Tn(this)));
      let e = null;
      if (
  ...
  class Gn {
    ...
    install(e) {
      const n = new Yn(e),
        a = Qn(this, Nn, "f").length;
      (Qn(this, Nn, "f").push(n),
        (Qn(this, Un, "f")[e.type] = n),
    ...
    item(e) {
      return Qn(this, Nn, "f")[e >>> 0];
    }
    namedItem(e) {
      return Qn(this, Un, "f")[e];
    }
    get length() {
      return Qn(this, Nn, "f").length;
    }
    [((Nn = new WeakMap()), (Un = new WeakMap()), Symbol.iterator)]() {
      return Qn(this, Nn, "f")[Symbol.iterator]();
    }
  ...
  class Yn {
    constructor(e) {
      (_n.set(this, void 0), Zn(this, _n, e, "f"));
    }
    get type() {
      return Qn(this, _n, "f").type;
    }
    get description() {
      return Qn(this, _n, "f").description;
    }
    get suffixes() {
      return Qn(this, _n, "f").suffixes;
    }
    get enabledPlugin() {
      return Qn(this, _n, "f").enabledPlugin;
    }
    get [((_n = new WeakMap()), Symbol.toStringTag)]() {
      return "MimeType";
    }
  }
  class Xn extends Gn {
  ...
  class ea {
    ...
    install(e) {
      const n = Qn(this, Jn, "f").length;
      (Qn(this, Jn, "f").push(e),
        (Qn(this, Kn, "f")[e.name] = e),
    ...
    item(e) {
      return Qn(this, Jn, "f")[e >>> 0];
    }
    namedItem(e) {
      return Qn(this, Kn, "f")[e];
    }
    refresh() {}
    [((Jn = new WeakMap()), (Kn = new WeakMap()), Symbol.iterator)]() {
      return Qn(this, Jn, "f")[Symbol.iterator]();
    }
    get [Symbol.toStringTag]() {
      return "PluginArray";
    }
    get length() {
      return Qn(this, Jn, "f").length;
    }
  }
  const na = new Xn("Shockwave Flash", "Shockwave Flash 32.0 r0", "ruffle.js");
  (na.install({
    type: Ie,
  ...
  const aa = window.RufflePlayer?.config ?? {},
    ta =
      (function (e) {
        let n = Ue?.href ?? "";
        return (
  ...
  function la() {
    try {
      ((ra = ra ?? document.getElementsByTagName("object")),
        (oa = oa ?? document.getElementsByTagName("embed")));
      for (const e of Array.from(ra))
        if (Ln.isInterdictable(e)) {
          const n = Ln.fromNativeObjectElement(e);
          e.replaceWith(n);
        }
      for (const e of Array.from(oa))
        if (In.isInterdictable(e)) {
          const n = In.fromNativeEmbedElement(e);
          e.replaceWith(n);
        }
    } catch (e) {
      console.error(
  ...
  function ua() {
    ((ia = ia ?? document.getElementsByTagName("iframe")),
      (sa = sa ?? document.getElementsByTagName("frame")),
      [ia, sa].forEach((e) => {
        for (const n of e) {
          ...
          try {
            "complete" === e.document.readyState && ca(e, a);
          } catch (e) {
            _e || console.warn(a + e);
          }
          n.addEventListener(
  ...
  async function ca(e, n) {
    ...
    try {
      ...
      return void (_e || console.warn(n + e));
    }
    if (_e || void 0 === a.documentElement.dataset.ruffleOptout)
      if (_e)
        ...
        (n.setAttribute("src", ta),
          (n.onload = () => {
            ((e.RufflePlayer = {}), (e.RufflePlayer.config = aa));
          }),
    ...
    !(function (e) {
      ...
      (("install" in navigator.plugins && navigator.plugins.install) ||
        ...
        Object.defineProperty(navigator, "plugins", {
          value: new ea(navigator.plugins),
          writable: !1,
          configurable: !0,
        })),
  ...
  function fa() {
    (("favorFlash" in aa && !1 === aa.favorFlash) ||
      "ruffle.js" ===
  ...
  const ma = {
    version: p.versionNumber + "+" + p.buildDate.substring(0, 10),
    polyfill() {
      fa();
    },
    pluginPolyfill() {
  ...
  !(function (e, n = {}) {
    let a;
    (window.RufflePlayer instanceof m
      ? (a = window.RufflePlayer)
      : ((a = new m(window.RufflePlayer)), (window.RufflePlayer = a)),
      (a.sources[e] = ma),
      (ma.options = n),
